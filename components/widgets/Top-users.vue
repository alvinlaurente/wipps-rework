                    ...
                    <table class="table table-borderless table-centered table-nowrap">
                        <tbody>
                            <tr v-for="(item, index) in users" :key="index">
                                ...
                                <td>
                                    <h6 class="font-size-15 mb-1 font-weight-normal">{{item.name}}</h6>
                                ...
                                <td>
                                    <span class="badge font-size-12" :class="{'badge-soft-success': item.status === 'Success',
                      'badge-soft-danger': item.status === 'Cancel',
                      'badge-soft-info': item.status === 'Active',
                      'badge-soft-warning': item.status === 'Pending'}">{{item.status}}</span>
                                </td>
