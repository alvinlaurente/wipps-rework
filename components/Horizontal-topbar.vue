...
<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            <b-dropdown variant="white" class="d-inline-block d-lg-none ml-2" toggle-class="header-item noti-icon" right menu-class="dropdown-menu-lg p-0">
            ...
            <b-dropdown variant="white" class="d-none d-lg-inline-block ml-1" toggle-class="header-item noti-icon" right menu-class="dropdown-menu-lg">
                <template v-slot:button-content>
                    <i class="uil-apps"></i>
                </template>
                <div class="px-lg-2">
            ...
            <b-dropdown variant="white" class="dropdown d-inline-block" toggle-class="header-item noti-icon" right menu-class="dropdown-menu-lg p-0">
                <template v-slot:button-content>
                    <i class="uil-bell"></i>
