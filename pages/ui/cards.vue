...
<div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <b-card-group deck>
                <b-card :img-src="require('~/assets/images/small/img-4.jpg')" img-alt="Card image" img-top class="mb-4">
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                ...
                <b-card :img-src="require('~/assets/images/small/img-5.jpg')" img-alt="Card image" img-top class="mb-4">
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
                ...
                <b-card :img-src="require('~/assets/images/small/img-6.jpg')" img-alt="Card image" img-top class="mb-4">
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
