            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        ...
                        <code class="highlighter-rouge">height: auto;</code> are applied
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm mr-3 rounded-circle" src="~/assets/images/users/avatar-6.jpg" alt="Generic placeholder image" height="64" />
                        <div class="media-body">
                            <h5 class="mt-0 font-size-14">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm mr-3 rounded-circle" src="~/assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="64" />
                        <div class="media-body">
                            <h5 class="mt-0 font-size-14">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                            scelerisque ante sollicitudin. Cras purus odio, vestibulum in
                            vulputate at, tempus viverra turpis. Fusce condimentum nunc ac
                            ...
                            <div class="media mt-3">
                                <a class="d-flex pr-3" href="javascript: void(0);">
                                    <img src="~/assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="64" class="avatar-sm rounded-circle" />
                                </a>
                                <div class="media-body">
                                    <h5 class="mt-0 font-size-14">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                    ...
                    <div class="media">
                        <div class="media-body">
                            <h5 class="mt-0 font-size-14">Media object</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                            scelerisque ante sollicitudin. Cras purus odio, vestibulum in
                            vulputate at, tempus viverra turpis. Fusce condimentum nunc ac
                            nisi vulputate fringilla. Donec lacinia congue felis in
                            faucibus.
                        </div>
                        <img class="d-flex ml-3 avatar-sm rounded-circle" src="~/assets/images/users/avatar-4.jpg" alt="Generic placeholder image" height="64" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm align-self-start rounded mr-3" src="~/assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="64" />
                        <div class="media-body">
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm align-self-center rounded mr-3" src="~/assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="64" />
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="avatar-sm align-self-end rounded mr-3" src="~/assets/images/users/avatar-1.jpg" alt="Generic placeholder image" height="64" />
                        <div class="media-body">
