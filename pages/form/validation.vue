                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="validationCustom01" v-model="form.fname" type="text" class="form-control" placeholder="First name" value="Mark" :class="{
                        'is-invalid': submitted && $v.form.fname.$error
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="validationCustom02" v-model="form.lname" type="text" class="form-control" placeholder="Last name" value="Otto" :class="{
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="validationCustom03" v-model="form.city" type="text" class="form-control" placeholder="City" :class="{
                        'is-invalid': submitted && $v.form.city.$error
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="validationCustom04" v-model="form.state" type="text" class="form-control" placeholder="State" :class="{
                        'is-invalid': submitted && $v.form.state.$error
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="validationCustom05" v-model="form.zipcode" type="text" class="form-control" placeholder="Zip" :class="{
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group position-relative">
                                    ...
                                    <input id="validationTooltip01" v-model="tooltipform.fname" type="text" class="form-control" placeholder="First name" value="Mark" :class="{
                        'is-invalid': submitform && $v.tooltipform.fname.$error
                            ...
                            <div class="col-md-4">
                                <div class="form-group position-relative">
                                    ...
                                    <input id="validationTooltip02" v-model="tooltipform.lname" type="text" class="form-control" placeholder="Last name" value="Otto" :class="{
                            ...
                            <div class="col-md-4">
                                <div class="form-group position-relative">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="validationTooltipUsername" v-model="tooltipform.username" type="text" class="form-control" placeholder="Username" aria-describedby="validationTooltipUsernamePrepend" :class="{
                          'is-invalid':
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group position-relative">
                                    ...
                                    <input id="validationTooltip03" v-model="tooltipform.city" type="text" class="form-control" placeholder="City" :class="{
                        'is-invalid': submitform && $v.tooltipform.city.$error
                            ...
                            <div class="col-md-6">
                                <div class="form-group position-relative">
                                    ...
                                    <input id="validationTooltip04" v-model="tooltipform.state" type="text" class="form-control" placeholder="State" :class="{
                ...
                <div class="card-body">
                    ...
                    <form action="#" @submit.prevent="typeForm">
                        <div class="form-group">
                            ...
                            <input v-model="typeform.name" type="text" class="form-control" placeholder="Type something" name="name" :class="{
                    'is-invalid': typesubmit && $v.typeform.name.$error
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input v-model="typeform.password" type="password" name="password" class="form-control" :class="{
                      'is-invalid': typesubmit && $v.typeform.password.$error
                            ...
                            <div class="mt-2">
                                <input v-model="typeform.confirmPassword" type="password" name="confirmPassword" class="form-control" :class="{
                      'is-invalid':
                        ...
                        <div class="form-group">
                            <label>E-Mail</label>
                            <div>
                                <input v-model="typeform.email" type="email" name="email" class="form-control" :class="{
                      'is-invalid': typesubmit && $v.typeform.email.$error
                        ...
                        <div class="form-group">
                            <label>URL</label>
                            <div>
                                <input v-model="typeform.url" type="url" name="url" class="form-control" placeholder="URL" :class="{
                      'is-invalid': typesubmit && $v.typeform.url.$error
                        ...
                        <div class="form-group">
                            <label>Digits</label>
                            <div>
                                <input v-model="typeform.digit" type="text" name="digit" class="form-control" :class="{
                      'is-invalid': typesubmit && $v.typeform.digit.$error
                        ...
                        <div class="form-group">
                            <label>Number</label>
                            <div>
                                <input v-model="typeform.number" type="text" name="number" class="form-control" :class="{
                      'is-invalid': typesubmit && $v.typeform.number.$error
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input v-model="typeform.alphanum" type="text" name="alphanum" class="form-control" :class="{
                      'is-invalid': typesubmit && $v.typeform.alphanum.$error
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea v-model="typeform.textarea" class="form-control" name="textarea" :class="{
                ...
                <div class="card-body">
                    ...
                    <form action="#" @submit.prevent="rangeform">
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <div v-if="submit && $v.range.minlen.$error" class="invalid-feedback">
                                    ...
                                    <span v-if="!$v.range.minlen.minLength">This value is too short. It should have 6 characters or
                                        more.</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <input v-model="range.maxlength" type="text" class="form-control" name="maxlength" :class="{
                      'is-invalid': submit && $v.range.maxlength.$error
                                ...
                                <div v-if="submit && $v.range.maxlength.$error" class="invalid-feedback">
                                    ...
                                    <span v-if="!$v.range.maxlength.maxLength">This value is too long. It should have 6 characters or
                                        fewer.</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <div v-if="submit && $v.range.between.$error" class="invalid-feedback">
                                    ...
                                    <span v-if="!$v.range.between.maxLength">This value length is invalid. It should be between 5 and
                                        10 characters long.</span>
                                    <span v-if="!$v.range.between.minLength">This value length is invalid. It should be between 5 and
                                        10 characters long.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input v-model="range.rangeval" type="text" class="form-control" name="rangeval" :class="{
