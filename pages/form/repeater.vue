                        ...
                        <div>
                            <div v-for="(field, index) in fields" :key="field.id" class="row">
                                <div class="form-group col-lg-2">
                                    ...
                                    <input id="name" v-model="field.name" type="text" name="untyped-input" class="form-control" />
                                </div>
                                ...
                                <div class="col-lg-2 align-self-center">
                                    <input type="button" class="btn btn-primary btn-block" value="Delete" @click="deleteRow(index)" />
                                </div>
                            </div>
                        </div>
                        <input type="button" class="btn btn-success mt-3 mt-lg-0" value="Add" @click="AddformData" />
                    </form>
                </div>
                <!-- end card-body -->
            </div>
                        ...
                        <div class="outer">
                            <div class="outer">
                                <div class="form-group">
                                    ...
                                    <input id="formname" type="text" class="form-control" placeholder="Enter your Name..." />
                                </div>

                                <div class="form-group">
                                    <label for="formemail">Email :</label>
                                    <input id="formemail" type="email" class="form-control" placeholder="Enter your Email..." />
                                </div>
                                    ...
                                    <div class="inner form-group">
                                        ...
                                        <div v-for="(data, index) in phoneData" :key="data.id" class="inner mb-3 row">
                                            <div class="col-md-10 col-8">
                                                <input v-model="data.phone" type="text" class="inner form-control" placeholder="Enter your phone no..." />
                                            </div>
                                            <div class="col-md-2 col-4">
                                                <input type="button" class="btn btn-primary btn-block inner" value="Delete" @click="deletePhone(index)" />
                                            </div>
                                        </div>
                                    </div>
                                    <input type="button" class="btn btn-success inner" value="Add Number" @click="AddPhoneNo" />
                                </div>
