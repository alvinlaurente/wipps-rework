    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="custom-accordion">
                <div class="card">
                    <a href="javascript: void(0);" class="text-dark" data-toggle="collapse" v-b-toggle.checkout-billinginfo-collapse>
                        <div class="p-4">
                ...
                <div class="card">
                    <a href="javascript: void(0);" class="collapsed text-dark" data-toggle="collapse" v-b-toggle.checkout-shippinginfo-collapse>
                        <div class="p-4">
                            <div class="media align-items-center">
                                <div class="mr-3">
                ...
                <div class="card">
                    <a class="collapsed text-dark" data-toggle="collapse" v-b-toggle.checkout-paymentinfo-collapse>
                        <div class="p-4">
                            <div class="media align-items-center">
                                <div class="mr-3">
            ...
            <div class="row my-4">
                <div class="col">
                    <nuxt-link to="/ecommerce/products" class="btn btn-link text-muted">
                        <i class="uil uil-arrow-left mr-1"></i> Continue Shopping
                    </nuxt-link>
                </div>
                <!-- end col -->
                <div class="col">
                    <div class="text-sm-right mt-2 mt-sm-0">
                        <a href="#" class="btn btn-success">
                            <i class="uil uil-shopping-cart-alt mr-1"></i> Procced
                        </a>
                    </div>
                </div>
                <!-- end col -->
                ...
                <div class="card-body">
                    <div class="p-3 bg-light mb-4">
                        <h5 class="font-size-16 mb-0">
                            Order Summary
                            <span class="float-right ml-2">#MN0124</span>
                        </h5>
                    </div>
                        ...
                        <table class="table table-centered mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate">
                                            <nuxt-link to="/ecommerce/product-detail/1" class="text-dark">Nike N012 Running Shoes</nuxt-link>
                                        </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate">
                                            <nuxt-link to="/ecommerce/product-detail/1" class="text-dark">Adidas Running Shoes</nuxt-link>
                                        </h5>
