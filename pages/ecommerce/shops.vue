...
<div>
    ...
    <div class="row">
        <div class="col-xl-4 col-sm-6" v-for="(item, index) in shops" :key="index">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <div class="avatar-sm mr-4">
                            <span :class="
                    `avatar-title bg-soft-${item.color} text-${item.color} font-size-16 rounded-circle`
                  ">
                                {{ item.name.charAt(0) }}
                            </span>
                        </div>
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> {{ item.desc }}
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="text-center my-3">
                <a href="javascript:void(0);" class="text-primary"><i class="mdi mdi-loading mdi-spin font-size-20 align-middle mr-2"></i>
                    Load more
                </a>
            </div>
        </div>
