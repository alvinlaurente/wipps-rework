    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="table-responsive mb-0">
                ...
                <b-table table-class="table table-centered datatable table-card-list" thead-tr-class="bg-transparent" :items="orderData" :fields="fields" responsive="sm" :per-page="perPage" :current-page="currentPage" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :filter="filter" :filter-included-fields="filterOn" @filtered="onFiltered">
                    ...
                    <template v-slot:cell(status)="data">
                        <div class="badge badge-pill badge-soft-success font-size-12" :class="{'badge-soft-danger': data.item.status === 'Chargeback',
                'badge-soft-warning': data.item.status ==='unpaid'}">{{ data.item.status }}</div>
                    </template>
